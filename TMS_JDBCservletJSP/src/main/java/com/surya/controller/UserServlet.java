...
//			 User user = userDao.getUserById(userId);
////		        List<User> users = userDao.selectAllUsers();
//		        System.out.println("userServlet_doGet>>>>>>>"+user);
//		        request.setAttribute("user", user);
//		        RequestDispatcher rd=request.getRequestDispatcher("editUser.jsp");
//		        rd.forward(request, response);
////		        response.sendRedirect("admin/adminDispTask.jsp");
...
//	    				getAll(request, response);
//	    			}
//	    			else if("editGetById".equals(action)) {
...
//	            }
//	        }
//	        System.out.println("editUser servlet::loopExit"+user);
//	        if (user != null) {
//	            // Update user details
//
//		        user.setUserRole(request.getParameter("userRole"));
...
//	            // Update user in the userService
//	            userDao.updateUser(user);
//	            System.out.println("userServlet::edit>>>>>>"+user);
//	            getAll(request, response);
//	        }
//
//	        response.sendRedirect("adminAddUser.jsp");
...
//	        try {
//	        	int userId = Integer.parseInt(request.getParameter("userId"));
//	        	System.out.println("userIdin Servlet>>>>>>"+userId);
//		        User user = userDao.getUserById(userId);
//		        System.out.println("userServletByiddddd>>>>>>>"+user);
//		        request.setAttribute("user", user);
//		        RequestDispatcher rd=request.getRequestDispatcher("editUser.jsp");
//		        rd.forward(request, response);
////		        response.sendRedirect("admin/adminDispTask.jsp");
